...
INSERT INTO course(course_name,course_language) VALUE ('Learn German!', 'German'); -- 3
INSERT INTO course(course_name,course_language) VALUE ('Learn English!', 'English'); -- 4
...
INSERT INTO quiz(quiz_title) VALUE ('German Part I'); -- 11
INSERT INTO has_quiz(course_id,quiz_id) VALUE(3,11);
INSERT INTO quiz(quiz_title) VALUE ('German Part II'); -- 12
INSERT INTO has_quiz(course_id,quiz_id) VALUE(3,12);
INSERT INTO quiz(quiz_title) VALUE ('German Part III'); -- 13
INSERT INTO has_quiz(course_id,quiz_id) VALUE(3,13);
INSERT INTO quiz(quiz_title) VALUE ('German Part IV'); -- 14
INSERT INTO has_quiz(course_id,quiz_id) VALUE(3,14);
INSERT INTO quiz(quiz_title) VALUE ('German Part V'); -- 15
INSERT INTO has_quiz(course_id,quiz_id) VALUE(3,15);

INSERT INTO quiz(quiz_title) VALUE ('English Part I'); -- 16
INSERT INTO has_quiz(course_id,quiz_id) VALUE(4,16);
INSERT INTO quiz(quiz_title) VALUE ('English Part II'); -- 17
INSERT INTO has_quiz(course_id,quiz_id) VALUE(4,17);
INSERT INTO quiz(quiz_title) VALUE ('English Part III'); -- 18
INSERT INTO has_quiz(course_id,quiz_id) VALUE(4,18);
INSERT INTO quiz(quiz_title) VALUE ('English Part IV'); -- 19
INSERT INTO has_quiz(course_id,quiz_id) VALUE(4,19);
INSERT INTO quiz(quiz_title) VALUE ('English Part V'); -- 20
